...
import xyz.contagent.social.socialnetwork.SocialNetwork;

import java.util.UUID;

/**
 * A {@link SocialMessage} is a {@link Message} that is sent between {@link Agent}s in a
 * {@link SocialNetwork}.
 *
...
public class SocialMessage implements Message {
    /**
     * The {@link UUID} of the {@link Agent} that this {@link SocialMessage} is sent to.
     *
     * @since v0.0.1
     */
    ...
    /**
     * The {@link UUID} of the {@link Agent} that this {@link SocialMessage} is sent
     * from.
     *
     * @since v0.0.1
     */
     ...
     *
     * @param destination The {@link UUID} of the {@link Agent} that this
     *                    {@link SocialMessage} is sent to.
     * @param sender      The {@link UUID} of the {@link Agent} that this
